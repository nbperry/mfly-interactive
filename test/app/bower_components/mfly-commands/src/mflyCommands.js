...
var mflyCommands = function () {
    ...
    return {
        ...
        showFullControlBars: function () {
            doControlStatement(prefix + "control/showFullControlBars");
        },

        hideFullControlBars: function () {
            doControlStatement(prefix + "control/hideFullControlBars");
        },
